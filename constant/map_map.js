...
// This is directly from pokefirered\include\constants\map_groups.h (slightly edited)
...
#define MAP_SAFFRON_CITY_CONNECTION          (11 | (3 << 8)) // Unused, FRLG only map
...
#define MAP_ROUTE21_NORTH                    (39 | (3 << 8)) // Unused, FRLG only map
...
#define MAP_PROTOTYPE_SEVII_ISLE_6           (50 | (3 << 8)) // Unused FRLG maps
...
#define MAP_SEVEN_ISLAND_TRAINER_TOWER       (62 | (3 << 8)) // Not the interior
...
#define MAP_VIRIDIAN_CITY_SCHOOL           (2 | (5 << 8)) // Trainer School
...
#define MAP_CERULEAN_CITY_HOUSE4           (8 | (7 << 8)) // Burgled house
#define MAP_CERULEAN_CITY_HOUSE5           (9 | (7 << 8)) // Berry Powder man

// gMapGroup_IndoorLavender
#define MAP_LAVENDER_TOWN_POKEMON_CENTER_1F      (0 | (8 << 8))
#define MAP_LAVENDER_TOWN_POKEMON_CENTER_2F      (1 | (8 << 8))
#define MAP_LAVENDER_TOWN_VOLUNTEER_POKEMON_HOUSE (2 | (8 << 8)) // Mr. Fuji's House
#define MAP_LAVENDER_TOWN_HOUSE1                 (3 | (8 << 8))
#define MAP_LAVENDER_TOWN_HOUSE2                 (4 | (8 << 8)) // Name Rater's House
#define MAP_LAVENDER_TOWN_MART                   (5 | (8 << 8))

// gMapGroup_IndoorVermilion
#define MAP_VERMILION_CITY_HOUSE1            (0 | (9 << 8)) // Fishing Guru
...
#define MAP_VERMILION_CITY_HOUSE2            (4 | (9 << 8)) // Pokemon Fan Club President? No, just a house
#define MAP_VERMILION_CITY_MART              (5 | (9 << 8))
#define MAP_VERMILION_CITY_GYM               (6 | (9 << 8))
#define MAP_VERMILION_CITY_HOUSE3            (7 | (9 << 8)) // Pokemon Journal house
...
#define MAP_CELADON_CITY_HOUSE1                    (18 | (10 << 8)) // Tea Man house
#define MAP_CELADON_CITY_HOTEL                     (19 | (10 << 8)) // Game Freak house

// gMapGroup_IndoorFuchsia
#define MAP_FUCHSIA_CITY_SAFARI_ZONE_ENTRANCE (0 | (11 << 8)) // Includes ticket check area
#define MAP_FUCHSIA_CITY_MART                 (1 | (11 << 8))
#define MAP_FUCHSIA_CITY_SAFARI_ZONE_OFFICE   (2 | (11 << 8)) // Unused FRLG map
#define MAP_FUCHSIA_CITY_GYM                  (3 | (11 << 8))
#define MAP_FUCHSIA_CITY_HOUSE1               (4 | (11 << 8)) // Move Deleter's House
...
#define MAP_FUCHSIA_CITY_HOUSE2               (8 | (11 << 8)) // Fishing Guru's brother
...
#define MAP_CINNABAR_ISLAND_POKEMON_LAB_EXPERIMENT_ROOM     (4 | (12 << 8)) // Fossil revival room
...
#define MAP_SAFFRON_CITY_HOUSE                    (4 | (14 << 8)) // Silph Co. President's House? No, just a house
...
#define MAP_SAFFRON_CITY_POKEMON_TRAINER_FAN_CLUB (9 | (14 << 8)) // Unused FRLG map

// gMapGroup_IndoorRoute2
#define MAP_ROUTE2_VIRIDIAN_FOREST_SOUTH_ENTRANCE (0 | (15 << 8)) // Building
#define MAP_ROUTE2_HOUSE                          (1 | (15 << 8)) // Cut HM guy
#define MAP_ROUTE2_EAST_BUILDING                  (2 | (15 << 8)) // Oak's Aide building (Flash)
#define MAP_ROUTE2_VIRIDIAN_FOREST_NORTH_ENTRANCE (3 | (15 << 8)) // Building
...
#define MAP_ROUTE5_SOUTH_ENTRANCE   (1 | (17 << 8)) // Underground Path Entrance Building

// gMapGroup_IndoorRoute6
#define MAP_ROUTE6_NORTH_ENTRANCE (0 | (18 << 8)) // Underground Path Entrance Building
#define MAP_ROUTE6_UNUSED_HOUSE   (1 | (18 << 8)) // Unused FRLG map

// gMapGroup_IndoorRoute7
#define MAP_ROUTE7_EAST_ENTRANCE (0 | (19 << 8)) // Underground Path Entrance Building

// gMapGroup_IndoorRoute8
#define MAP_ROUTE8_WEST_ENTRANCE (0 | (20 << 8)) // Underground Path Entrance Building
...
#define MAP_ROUTE11_EAST_ENTRANCE_1F (0 | (22 << 8)) // Gatehouse
#define MAP_ROUTE11_EAST_ENTRANCE_2F (1 | (22 << 8)) // Gatehouse (Oak's Aide - Itemfinder)

// gMapGroup_IndoorRoute12
#define MAP_ROUTE12_NORTH_ENTRANCE_1F (0 | (23 << 8)) // Gatehouse
#define MAP_ROUTE12_NORTH_ENTRANCE_2F (1 | (23 << 8)) // Gatehouse (Girl who gives TM)
#define MAP_ROUTE12_FISHING_HOUSE     (2 | (23 << 8)) // Fishing Guru's Brother (Super Rod)

// gMapGroup_IndoorRoute15
#define MAP_ROUTE15_WEST_ENTRANCE_1F (0 | (24 << 8)) // Gatehouse
#define MAP_ROUTE15_WEST_ENTRANCE_2F (1 | (24 << 8)) // Gatehouse (Oak's Aide - Exp. Share)

// gMapGroup_IndoorRoute16
#define MAP_ROUTE16_HOUSE            (0 | (25 << 8)) // Fly HM house
#define MAP_ROUTE16_NORTH_ENTRANCE_1F (1 | (25 << 8)) // Gatehouse
#define MAP_ROUTE16_NORTH_ENTRANCE_2F (2 | (25 << 8)) // Gatehouse (Oak's Aide - Amulet Coin)

// gMapGroup_IndoorRoute18
#define MAP_ROUTE18_EAST_ENTRANCE_1F (0 | (26 << 8)) // Gatehouse
#define MAP_ROUTE18_EAST_ENTRANCE_2F (1 | (26 << 8)) // Gatehouse

// gMapGroup_IndoorRoute19
#define MAP_ROUTE19_UNUSED_HOUSE     (0 | (27 << 8)) // Unused FRLG map

// gMapGroup_IndoorRoute22
#define MAP_ROUTE22_NORTH_ENTRANCE (0 | (28 << 8)) // Gatehouse (Pokemon League Reception Gate)

// gMapGroup_IndoorRoute23
#define MAP_ROUTE23_UNUSED_HOUSE   (0 | (29 << 8)) // Unused FRLG map

// gMapGroup_IndoorRoute25
#define MAP_ROUTE25_SEA_COTTAGE (0 | (30 << 8)) // Bill's House

// gMapGroup_IndoorSevenIsland
#define MAP_SEVEN_ISLAND_HOUSE_ROOM1       (0 | (31 << 8)) // Move Tutor house left room
#define MAP_SEVEN_ISLAND_HOUSE_ROOM2       (1 | (31 << 8)) // Move Tutor house right room
...
#define MAP_SEVEN_ISLAND_UNUSED_HOUSE      (5 | (31 << 8)) // Unused FRLG map
...
#define MAP_TWO_ISLAND_HOUSE              (1 | (33 << 8)) // Move Tutor house
...
#define MAP_FOUR_ISLAND_HOUSE1            (3 | (35 << 8)) // Move Tutor House
#define MAP_FOUR_ISLAND_LORELEIS_HOUSE    (4 | (35 << 8))
#define MAP_FOUR_ISLAND_HARBOR            (5 | (35 << 8))
#define MAP_FOUR_ISLAND_HOUSE2            (6 | (35 << 8)) // Sticker house
...
#define MAP_TWO_ISLAND_CAPE_BRINK_HOUSE (0 | (40 << 8)) // Move Tutor House

// gMapGroup_IndoorSixIslandRoute
#define MAP_SIX_ISLAND_WATER_PATH_HOUSE1 (0 | (41 << 8))
#define MAP_SIX_ISLAND_WATER_PATH_HOUSE2 (1 | (41 << 8)) // Heracross/Pinsir trade
...
/**
 * Parses C preprocessor map definitions into a nested JavaScript Map.
 * @param {string} definitionString - The string containing the #define statements.
 * @returns {Map<number, Map<number, string>>} - A Map where keys are group numbers
 * and values are Maps. The inner Maps have map numbers as keys and map names as values.
 */
function parseMapDefinitions(definitionString) {
    const mapLookup = new Map();
    const lines = definitionString.split('\n');
    // Regex to capture MAP_NAME, mapNumber, and groupNumber
    const defineRegex = /^#define\s+(MAP_\w+)\s+\((\d+)\s*\|\s*\((\d+)\s*<<\s*8\)\)/;
    ...
    for (const line of lines) {
        ...
        if (trimmedLine.startsWith('#define')) {
            ...
            if (match) {
                const [, mapName, mapNumStr, groupNumStr] = match;
                const mapNumber = parseInt(mapNumStr, 10);
                const groupNumber = parseInt(groupNumStr, 10);

                if (!mapLookup.has(groupNumber)) {
                    mapLookup.set(groupNumber, new Map());
                }
                const innerMap = mapLookup.get(groupNumber);
                innerMap.set(mapNumber, mapName);
            }
        }
    }
    return mapLookup;
...
const mapLookup = parseMapDefinitions(MAP_NAMES);
